@section('meta_tag')
    <meta name="description" content="{{ optional($pageSetups['beranda'])->meta_description ?? '' }}">
    <meta name="keywords" content="{{ optional($pageSetups['beranda'])->meta_keywords ?? '' }}">
    <meta name="author" content="RECODEX ID">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name="robots" content="index, follow">

    <meta property="og:title" content="{{ optional($pageSetups['beranda'])->title ?? 'Beranda' }}">
    <meta property="og:description" content="{{ optional($pageSetups['beranda'])->meta_description ?? '' }}">
    ...
    <meta name="twitter:title" content="{{ optional($pageSetups['beranda'])->title ?? 'Beranda' }}">
    <meta name="twitter:description" content="{{ optional($pageSetups['beranda'])->meta_description ?? '' }}">
    ...
    <title>{{ optional($pageSetups['beranda'])->title ?? 'Beranda' }}</title>
@endsection
