@section('meta_tag')
    <meta name="description" content="{{ optional($pageSetups['kontak'])->meta_description ?? '' }}">
    <meta name="keywords" content="{{ optional($pageSetups['kontak'])->meta_keywords ?? '' }}">
    <meta name="author" content="RECODEX ID">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name="robots" content="index, follow">

    <meta property="og:title" content="{{ optional($pageSetups['kontak'])->title ?? 'Kontak Kami' }}">
    <meta property="og:description" content="{{ optional($pageSetups['kontak'])->meta_description ?? '' }}">
    ...
    <meta name="twitter:title" content="{{ optional($pageSetups['kontak'])->title ?? 'Kontak Kami' }}">
    <meta name="twitter:description" content="{{ optional($pageSetups['kontak'])->meta_description ?? '' }}">
    ...
    <title>{{ optional($pageSetups['kontak'])->title ?? 'Kontak Kami' }}</title>
@endsection
